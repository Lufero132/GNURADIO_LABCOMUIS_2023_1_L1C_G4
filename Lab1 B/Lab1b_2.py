...
class Lab1b_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_b_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_b_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1b_2")
        ...
        self._samp_rate_range = Range(100, 40000, 100, 25000, 200)
        ...
        self._freq_range = Range(100, 40000, 100, 5000, 200)
...
def main(top_block_cls=Lab1b_2, options=None):
