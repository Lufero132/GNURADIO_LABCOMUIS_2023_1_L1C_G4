...
class Lab1b_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "punto_Audio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto_Audio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1b_4")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('despecha_rosalia.wav', True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(conts)
    ...
    def set_conts(self, conts):
        self.conts = conts
        self.blocks_multiply_const_vxx_0.set_k(self.conts)
...
def main(top_block_cls=Lab1b_4, options=None):
