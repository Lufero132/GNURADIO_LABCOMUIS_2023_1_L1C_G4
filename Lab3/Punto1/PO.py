...
class PO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PO")
        ...
        self._AMP_win = RangeWidget(self._AMP_range, self.set_AMP, "Amplitud", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=PO, options=None):
